...
function ImageGenerateSection() {
    ...
    return (
        <section className="h-max sm:h-[85dvh] w-[67dvw] mt-[12dvh] p-2 flex flex-col sm:flex-row justify-between gap-4  bg-gradient-to-r from-pink-50 to-purple-50 rounded-xl">
            <PromptForm />
            <ImageGrid />
        </section>
    )
